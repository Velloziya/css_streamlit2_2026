...
if menu == "Academic Profile":
    ...
    # Display image directly from project files (NO UPLOADER)
    st.image("https://www.epa.gov/sites/default/files/styles/large/public/2021-05/aqaw_2021_0.png?itok=FwknteTh", caption="Good Air Quality-Bad Air Quality (EPA,2021)", use_container_width=True)
